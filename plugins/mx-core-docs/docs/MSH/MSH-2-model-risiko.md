...
- [**Module 6** akan menunjukkan bagaimana keputusan risiko dibatasi dan diarahkan oleh **SHE sebagai sistem constraint**.](/blog/management/MSH/MSH-7-she-compliance)
- [**Module 7** akan menutup siklus dengan **evaluasi kinerja, audit, dan perbaikan berkelanjutan**](/blog/management/MSH/MSH-8-lifecycle-ta)
