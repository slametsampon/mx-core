...
└── src/
    ├── index.ts             ← Entrypoint modul
    ├── ui/                  ← Komponen Next.js (opsional)
    ├── api/                 ← API handler (opsional)
    └── schema/              ← Model lokal (jika ada)
```
...
[
  {
    "name": "mx-core-docs",
    "type": "static",
    "url": "https://your-org.github.io/mx-core-docs/"
  },
  {
    "name": "mx-core-ai",
    "type": "dynamic",
    "entry": "/api/plugins/mx-core-ai"
  }
]
```
