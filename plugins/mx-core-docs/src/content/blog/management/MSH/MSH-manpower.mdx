...
- [**_Strategi Manpower dalam Ekosistem Risk-Based Maintenance (RBM)_**](#strategi-manpower-dalam-ekosistem-risk-based-maintenance-rbm)
...
- [📚 Daftar Referensi :](#-daftar-referensi-)
  ...
  - [Lokasi: Setelah **Prolog Artikel**, sebelum Bab 1](#lokasi-setelah-prolog-artikel-sebelum-bab-1)
  - [Lokasi: Setelah Bab **1. Pendahuluan — Mengapa Manpower Perlu Dibahas Terpisah dari MSH**](#lokasi-setelah-bab-1-pendahuluan--mengapa-manpower-perlu-dibahas-terpisah-dari-msh)
  - [Lokasi: Setelah Bab **2. Posisi Manpower dalam RBM — Manusia sebagai Barrier Aktif**](#lokasi-setelah-bab-2-posisi-manpower-dalam-rbm--manusia-sebagai-barrier-aktif)
  - [Lokasi: Setelah Bab **3. Keterkaitan Artikel Ini dengan MSH-3**](#lokasi-setelah-bab-3-keterkaitan-artikel-ini-dengan-msh-3)
  - [Lokasi: Setelah Bab **4. Keterkaitan Artikel Ini dengan MSH-5**](#lokasi-setelah-bab-4-keterkaitan-artikel-ini-dengan-msh-5)
  - [Lokasi: Setelah Bab **5. Risk-Based Manpower Tiering**](#lokasi-setelah-bab-5-risk-based-manpower-tiering)
  - [Lokasi: Setelah Bab **6. Competency Design Berbasis Risiko**](#lokasi-setelah-bab-6-competency-design-berbasis-risiko)
  - [Lokasi: Setelah Bab **7. Training Strategy dalam Ekosistem RBM**](#lokasi-setelah-bab-7-training-strategy-dalam-ekosistem-rbm)
  - [Lokasi: Setelah Bab **8. Authority, Escalation, dan Stop-Work dalam RBM**](#lokasi-setelah-bab-8-authority-escalation-dan-stop-work-dalam-rbm)
  - [Lokasi: Setelah Bab **9. Manpower dalam Evaluation Loop RBM**](#lokasi-setelah-bab-9-manpower-dalam-evaluation-loop-rbm)
  - [Lokasi: Setelah Bab **10. KPI Manpower yang Selaras dengan RBM**](#lokasi-setelah-bab-10-kpi-manpower-yang-selaras-dengan-rbm)
  - [Lokasi: Setelah Bab **11. Penutup — Manpower sebagai Penentu Hidup-Matinya RBM**](#lokasi-setelah-bab-11-penutup--manpower-sebagai-penentu-hidup-matinya-rbm)
  - [Lokasi: Setelah Bab **12. Rekomendasi Pembaca \& Integrasi**](#lokasi-setelah-bab-12-rekomendasi-pembaca--integrasi)
...
```mermaid id="manpower-rbm-human-consequence-layer-mobile"
flowchart TD
    A["MSH-3<br/>Risk-Based Maintenance"] --> C["Human<br/>Consequence Layer"]
    B["MSH-5<br/>Organization & Accountability"] --> C

    C --> D["Competency<br/>Aligned with Risk"]
    C --> E["Authority<br/>Aligned with Risk"]
    C --> F["Behavior<br/>Aligned with Risk"]

    D --> G["Manpower as<br/>Active Risk Control"]
    E --> G
    F --> G

    G --> H["RBM Lives<br/>in the Field"]

    classDef msh fill:#E3F2FD,stroke:#1565C0,color:#111;
    classDef layer fill:#FFF8E1,stroke:#F9A825,color:#111;
...
```mermaid id="why-manpower-separate-from-msh-mobile"
flowchart TD
    A["MSH<br/>System Design"] --> B["Correct Risk<br/>Decision"]
    B --> C{"Executed<br/>Correctly?"}

    C -- "No" --> D["Competency<br/>Gap"]
    C -- "No" --> E["Authority<br/>Gap"]
    C -- "No" --> F["Escalation<br/>Gap"]

    D --> G["RBM Becomes<br/>Weak in Field"]
    E --> G
    F --> G

    C -- "Yes" --> H["RBM Becomes<br/>Living System"]
    ...
    classDef weak fill:#FCE4EC,stroke:#AD1457,color:#111;
...
```mermaid id="manpower-active-barrier-rbm-mobile"
flowchart TD
    A["Manpower<br/>Quality"] --> B["Technical<br/>Competency"]
    A --> C["Risk<br/>Awareness"]
    A --> D["Decision<br/>Authority"]

    B --> E["Better Inspection<br/>& Diagnosis"]
    C --> F["Faster Escalation<br/>of Abnormality"]
    D --> G["Stop-Work<br/>When Trigger Appears"]

    E --> H["Lower<br/>Probability of Failure"]
    F --> I["Limit<br/>ESC Consequence"]
    G --> I

    H --> J["Controlled<br/>Residual Risk"]
    I --> J

    classDef input fill:#E3F2FD,stroke:#1565C0,color:#111;
    classDef capability fill:#E8F5E9,stroke:#2E7D32,color:#111;
...
```mermaid id="msh3-to-manpower-execution-mobile"
flowchart TD
    A["MSH-3<br/>Risk Decision"] --> B["Maintenance<br/>Strategy"]
    B --> C["Risk-Based<br/>Action Required"]
    C --> D{"Who Executes<br/>the Decision?"}

    D --> E["Competent<br/>Person"]
    D --> F["Authorized<br/>Person"]
    D --> G["Risk-Aware<br/>Person"]

    E --> H["Correct<br/>Field Execution"]
    F --> H
    G --> H

    H --> I["RBM Decision<br/>Becomes Real"]

    classDef msh fill:#E3F2FD,stroke:#1565C0,color:#111;
    classDef decision fill:#FFF8E1,stroke:#F9A825,color:#111;
    classDef people fill:#E8F5E9,stroke:#2E7D32,color:#111;
    classDef output fill:#F3E5F5,stroke:#6A1B9A,color:#111;

    class A,B msh;
    class C,D decision;
    class E,F,G,H people;
    class I output;
```
...
```mermaid id="formal-organization-vs-risk-authority-mobile"
flowchart TD
    A["Formal<br/>Organization"] --> B["Who Reports<br/>to Whom"]
    C["Risk-Based<br/>Authority"] --> D["Who Must Act<br/>When Risk Rises"]

    B --> E{"Authority<br/>Aligned?"}
    D --> E

    E -- "No" --> F["Ambiguity<br/>of Authority"]
    F --> G["Late Escalation<br/>or No Stop-Work"]

    E -- "Yes" --> H["Fast Decision<br/>Based on Risk Trigger"]
    H --> I["Accountable<br/>Risk Control"]

    classDef formal fill:#E3F2FD,stroke:#1565C0,color:#111;
...
```mermaid id="risk-based-manpower-tiering-mobile"
flowchart TD
    A["Asset<br/>Risk Tiering"] --> B{"Asset<br/>Tier?"}

    B -- "Tier 1<br/>Very Critical" --> C["Senior Engineer<br/>Full Stop-Work Authority"]
    B -- "Tier 2<br/>Critical Support" --> D["Engineer + Supervisor<br/>Controlled Escalation"]
    B -- "Tier 3<br/>Normal Asset" --> E["Technician<br/>Strict SOP Execution"]

    C --> F["High Competency<br/>High Authority"]
    D --> G["Moderate Competency<br/>Defined Authority"]
    E --> H["Standard Competency<br/>Procedure-Based Control"]

    F --> I["Manpower<br/>Proportional to Risk"]
    G --> I
    H --> I
...
```mermaid id="risk-based-competency-design-mobile"
flowchart TD
    A["Risk Consequence<br/>ESC"] --> B["Required<br/>Competency Level"]

    B --> C["Technical<br/>Understanding"]
    B --> D["Risk<br/>Awareness"]
    B --> E["Decision & Stop-Work<br/>Authority"]

    C --> F["Understand<br/>Failure Mechanism"]
    D --> G["Recognize<br/>System Consequence"]
    E --> H["Act When<br/>Risk Trigger Appears"]

    F --> I["Fitness<br/>for Task"]
    G --> I
    H --> I
...
```mermaid id="rbm-training-ladder-mobile"
flowchart TD
    A["RBM<br/>Training Ladder"] --> B["Technician<br/>Detect Abnormality"]
    A --> C["Engineer<br/>Analyze Failure & ESC"]
    A --> D["Supervisor<br/>Manage Escalation"]
    A --> E["Management<br/>Risk Acceptance"]

    B --> F["Early Detection<br/>and SOP Discipline"]
    C --> G["Risk-Based<br/>Technical Decision"]
    D --> H["Correct<br/>Decision Threshold"]
    E --> I["Support<br/>Defensible Decision"]

    F --> J["Layered<br/>Risk Control"]
    G --> J
    H --> J
    I --> J

    classDef ladder fill:#E3F2FD,stroke:#1565C0,color:#111;
    classDef role fill:#E8F5E9,stroke:#2E7D32,color:#111;
    classDef output fill:#FFF8E1,stroke:#F9A825,color:#111;
...
```mermaid id="authority-escalation-stopwork-rbm-mobile"
flowchart TD
    A["Field<br/>Abnormality"] --> B{"Risk Trigger<br/>Reached?"}

    B -- "No" --> C["Continue Work<br/>Within SOP"]
    B -- "Yes" --> D["Activate<br/>Risk-Based Authority"]

    D --> E{"Can Risk<br/>Be Controlled?"}
    E -- "Yes" --> F["Apply Control<br/>and Monitor"]
    E -- "No" --> G["Stop-Work<br/>Immediately"]

    G --> H["Escalate to<br/>Competent Authority"]
    H --> I["Technical / Operational<br/>Decision"]
    I --> J["Document<br/>Decision & Learning"]
...
```mermaid id="manpower-evaluation-loop-rbm-mobile"
flowchart TD
    A["Field Execution<br/>by Manpower"] --> B["Collect Evidence<br/>Decision / Response / Near-Miss"]
    B --> C["Evaluate<br/>Manpower Barrier Quality"]
    C --> D{"Gap<br/>Found?"}

    D -- "No" --> E["Maintain<br/>Current Assignment"]
    D -- "Yes" --> F["Systemic<br/>Improvement Action"]

    F --> G["Retraining"]
    F --> H["Repositioning"]
    F --> I["Authority<br/>Redesign"]

    G --> J["Updated<br/>Manpower Strategy"]
    H --> J
    I --> J
...
```mermaid id="risk-based-manpower-kpi-mobile"
flowchart TD
    A["Manpower KPI<br/>in RBM"] --> B["Risk<br/>Response"]
    A --> C["Escalation<br/>Quality"]
    A --> D["Decision<br/>Accuracy"]
    A --> E["Near-Miss<br/>Handling"]

    B --> F["How Fast<br/>Risk is Recognized"]
    C --> G["How Correct<br/>Escalation Path is Used"]
    D --> H["How Suitable<br/>Decision vs Risk"]
    E --> I["How Strong<br/>Learning is Captured"]

    F --> J["Risk-Based<br/>Performance"]
    G --> J
    H --> J
    I --> J

    classDef kpi fill:#E3F2FD,stroke:#1565C0,color:#111;
    classDef metric fill:#E8F5E9,stroke:#2E7D32,color:#111;
    classDef meaning fill:#FFF8E1,stroke:#F9A825,color:#111;
    classDef output fill:#F3E5F5,stroke:#6A1B9A,color:#111;

    class A kpi;
    class B,C,D,E metric;
    class F,G,H,I meaning;
    class J output;
```
...
```mermaid id="rbm-lives-through-manpower-mobile"
flowchart TD
    A["RBM<br/>Model & Strategy"] --> B["Organization<br/>and Accountability"]
    B --> C["Risk-Based<br/>Manpower Strategy"]

    C --> D["Right Person"]
    C --> E["Right Competency"]
    C --> F["Right Authority"]
    C --> G["Right Escalation"]

    D --> H["Correct<br/>Risk Decision"]
    E --> H
    F --> H
    G --> H

    H --> I["RBM Becomes<br/>Operationally Alive"]

    classDef rbm fill:#E3F2FD,stroke:#1565C0,color:#111;
    classDef manpower fill:#FFF8E1,stroke:#F9A825,color:#111;
    classDef element fill:#E8F5E9,stroke:#2E7D32,color:#111;
    classDef output fill:#F3E5F5,stroke:#6A1B9A,color:#111;

    class A,B rbm;
    class C manpower;
    class D,E,F,G,H element;
    class I output;
```
...
```mermaid id="manpower-rbm-integration-roadmap-mobile"
flowchart TD
    A["Start<br/>RBM Manpower Review"] --> B["Evaluate<br/>Asset Tier vs Manpower"]
    B --> C["Review<br/>Authority & Escalation"]
    C --> D["Check<br/>Stop-Work Clarity"]
    D --> E["Redesign<br/>Training Ladder"]
    E --> F["Set<br/>Risk-Based KPI"]
    F --> G["Feed into<br/>Evaluation Loop"]
    G --> H["Improve<br/>RBM Execution"]

    classDef start fill:#E3F2FD,stroke:#1565C0,color:#111;
    classDef review fill:#FFF8E1,stroke:#F9A825,color:#111;
    classDef redesign fill:#E8F5E9,stroke:#2E7D32,color:#111;
