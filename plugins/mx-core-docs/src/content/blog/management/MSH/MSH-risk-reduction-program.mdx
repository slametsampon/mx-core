...
<figure>
  <img src="/static/images/artikel/konsep-rrp-pon-1.png" alt="Konsep RRP PON" />
  <figcaption>
...
Untuk konteks plant, scope RRP terdiri atas cluster berikut.
...
| NPG Unit     | FA/Formaldehyde unit, aldol condensation, hydrogenation, reactor, distillation column, flaker, bagging system, product handling |
...
NPG Unit perlu dimasukkan sebagai cluster tersendiri karena memiliki kombinasi risiko proses reaksi, distilasi, hydrogenation, solidification, dan product handling. Berbeda dengan unit yang hanya berfokus pada proses fluida, NPG juga memiliki area akhir berupa flaker dan bagging system yang memengaruhi kualitas produk, operability, housekeeping, serta kontinuitas dispatch.

Ruang lingkup minimum NPG Unit meliputi:

- **FA / Formaldehyde Unit**, terutama reactor dan distillation column;
- **Aldol Condensation**, terutama reactor dan column;
- **Hydrogenation**, terutama reactor, hydrogen system, catalyst, compressor/pump terkait, dan column;
- **Flaker System**, termasuk cooling surface, scraper/knife, drive system, product cooling, dan discharge;
- **Bagging System**, termasuk conveyor, weighing, filling, sealing, dust handling, dan product transfer.

#### Karakter Risiko Utama

| Area                       | Risiko Dominan                                                                                   | Fokus Engineer                                                                                      |
| -------------------------- | ------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------- |
| FA / Formaldehyde Reactor  | Instabilitas reaksi, temperature excursion, catalyst/performance issue, feed quality sensitivity | Temperature control, feed ratio, catalyst condition, heat removal, interlock, analyzer              |
| FA Distillation Column     | Flooding, weeping, pressure instability, off-spec intermediate, fouling                          | Column ΔP, reflux ratio, reboiler/condenser duty, tray/packing condition, control stability         |
| Aldol Condensation Reactor | Reaction instability, selectivity issue, fouling, temperature control limitation                 | Operating envelope, mixing, heat removal, catalyst/chemical condition, residence time               |
| Aldol Column               | Separation instability, off-spec stream, pressure drop, reboiler/condenser limitation            | Column performance, ΔP, temperature profile, reflux, heat duty, fouling                             |
| Hydrogenation Reactor      | Hydrogen leak, catalyst deactivation, hot spot, pressure instability, product quality issue      | Hydrogen control, catalyst life, reactor temperature profile, pressure control, emergency isolation |
| Hydrogenation Column       | Off-spec product, pressure instability, fouling, energy inefficiency                             | Reboiler duty, condenser duty, tray/packing condition, pressure and temperature profile             |
| Flaker System              | Poor solidification, uneven flake thickness, scraper failure, product buildup, drive overload    | Cooling performance, drum/belt condition, scraper alignment, drive reliability, discharge stability |
| Bagging System             | Filling inaccuracy, sealing failure, dust exposure, conveyor jam, product contamination          | Weighing accuracy, sealing quality, dust collection, conveyor reliability, housekeeping, ergonomics |

#### Apa yang Harus Dilakukan Engineer

Pada NPG Unit, engineer perlu melihat risiko dari hulu ke hilir: dari kualitas formaldehyde, kestabilan reaksi, performa distilasi, hydrogenation, sampai kemampuan flaker dan bagging menjaga produk tetap sesuai spesifikasi dan dapat dikirim.

Beberapa pertanyaan praktis:

- Apakah reactor memiliki kontrol temperatur yang stabil pada variasi beban?
- Apakah column menunjukkan tren kenaikan pressure drop atau perubahan temperature profile?
- Apakah reboiler dan condenser memiliki duty margin yang cukup?
- Apakah hydrogenation reactor menunjukkan indikasi catalyst deactivation atau hot spot?
- Apakah flaker mampu menghasilkan produk dengan ukuran, ketebalan, dan kadar pendinginan yang konsisten?
- Apakah scraper/knife, drive, bearing, dan cooling surface pada flaker menjadi bad actor?
- Apakah bagging system menyebabkan bottleneck dispatch, off-weight bag, sealing failure, atau dust exposure?
- Apakah dust collector, ventilation, dan housekeeping cukup untuk mengendalikan risiko operasional dan keselamatan kerja?

Contoh RRP NPG:

> Bila flaker sering menyebabkan product buildup dan trip drive, tindakan RRP tidak boleh langsung berupa penggantian drive motor. Engineer perlu mengevaluasi cooling performance, karakteristik produk, drum atau belt surface condition, scraper alignment, knife wear, discharge chute, bearing condition, serta interlock overload. Penggantian motor hanya tepat apabila terbukti kapasitas drive tidak memadai atau terjadi degradation yang tidak dapat dipulihkan.

Contoh lain:

> Bila column pada FA atau Aldol menunjukkan pressure drop meningkat dan kualitas produk tidak stabil, RRP perlu memeriksa tray/packing fouling, reboiler duty, condenser performance, reflux control, feed composition, serta control valve performance sebelum memutuskan cleaning, internal inspection, atau modification.
...
### 4.6 Mengelola Batas Antar-Unit
...
| Bagging system menjadi bottleneck produk akhir NPG       | Fokus hanya pada mechanical conveyor atau sealer             | Evaluasi integrasi flaker, product cooling, weighing, sealing, dust handling, dan dispatch requirement     |
| FA atau Aldol column tidak stabil                        | Hanya mengubah operating parameter                           | Evaluasi column internals, reboiler/condenser duty, feed composition, control valve, dan fouling mechanism |
