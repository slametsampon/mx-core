...
- [**_Dari Risk-Based Thinking ke Reliability-Driven Organization: Panduan Lengkap Maintenance System Handbook_**](#dari-risk-based-thinking-ke-reliability-driven-organization-panduan-lengkap-maintenance-system-handbook)
...
- [**Bagian III — MSH Maturity Assessment Tool**](#bagian-iii--msh-maturity-assessment-tool)
  ...
  - [**📌 Artikel Pendukung MSH (Execution \& Human System Extension)**](#-artikel-pendukung-msh-execution--human-system-extension)
    - [🧩 **1. Strategi Manpower dalam Ekosistem Risk-Based Maintenance (RBM)**](#-1-strategi-manpower-dalam-ekosistem-risk-based-maintenance-rbm)
    - [🧩 **2. Job Description Berbasis Risiko dalam Ekosistem RBM**](#-2-job-description-berbasis-risiko-dalam-ekosistem-rbm)
    - [🧩 **3. Instruksi Kerja (IK/WI) Berbasis Risiko dalam Ekosistem RBM**](#-3-instruksi-kerja-ikwi-berbasis-risiko-dalam-ekosistem-rbm)
...
```mermaid
flowchart TB
    A[MSH<br/>Maintenance System Handbook] --> B[Module 0-1<br/>Konteks & Filosofi]
    A --> C[Module 2<br/>Risk Decision Logic]
    A --> D[Module 3<br/>RBM Strategy]
    A --> E[Module 4<br/>Budgeting]
    A --> F[Module 5<br/>Organization & KPI]
    A --> G[Module 6<br/>Execution & Learning]
    A --> H[Module 7<br/>SHE Constraint]
    A --> I[Module 8<br/>Lifecycle & TA]

    classDef core fill:#e0f2fe,stroke:#0284c7,stroke-width:2px,color:#0f172a;
    classDef risk fill:#fee2e2,stroke:#dc2626,stroke-width:2
```
...
items={[
{
name: 'Budgeting Maintenance Berbasis RBM',
...
Module ini mengunci _risk barrier cost_, membedakan biaya mandatory dan optimizable, serta menjadi jembatan antara RBM dan governance organisasi.

👉 Output utama: **komitmen sumber daya yang selaras dengan risk appetite perusahaan**.
...
- **Tahap 4 — Budgeting & Komitmen Sumber Daya (Decision Consequence Layer)**

**Target audiens:**
Maintenance manager, engineering manager, finance partner
...
- Perbedaan _mandatory risk barrier cost_ vs biaya yang dapat dioptimasi
...
- **Tahap 5 — Organisasi & Akuntabilitas**
...
- **Tahap 7 — Batas SHE & Keberlanjutan**
...
| **Budgeting & Resource Governance** | Modul 4   |
| **Organisasi & KPI**                | Modul 5   |
| **Eksekusi & Learning**             | Modul 6   |
| **SHE sebagai Constraint**          | Modul 7   |
| **Lifecycle & Improvement**         | Modul 8   |
...
- 🔹 4. Modul 4: Budgeting & Resource Governance
...
- 🔹 5. Modul 5: Organisasi, KPI & Akuntabilitas
...
- 🔹 6. Modul 6: Eksekusi, RCA & Learning Loop
...
- 🔹 7. Modul 7: SHE sebagai System Constraint
...
- 🔹 8. Modul 8: Lifecycle, TA & Continuous Improvement
...
## **📌 Artikel Pendukung MSH (Execution & Human System Extension)**
...
> **“Bagaimana keputusan berbasis risiko benar-benar dijalankan oleh manusia, struktur organisasi, dan instruksi kerja di lapangan?”**
...
🔗 _Direkomendasikan dibaca setelah:_
**MSH-3 (RBM)** dan sebelum **MSH-5 (Organization & Accountability)**
...
- **MSH-3** → menetapkan logika keputusan risiko
- **MSH-manpower** → menetapkan manusia sebagai active barrier
- **MSH-jobdesc** → **mengunci keputusan RBM ke dalam peran, otoritas, dan tanggung jawab jabatan**

Tanpa JobDesc berbasis risiko, governance RBM akan runtuh pada saat terjadi tekanan produksi atau konflik kepentingan.

🔗 _Direkomendasikan dibaca setelah:_
**MSH-3 (RBM)** dan **MSH-manpower**
...
> **risk execution layer** — tempat seluruh asumsi risiko diuji secara nyata di lapangan.
...
- Jika RBM adalah _decision logic_,
- JobDesc adalah _decision authority_,
...
🔗 _Direkomendasikan dibaca setelah:_
**MSH-3 (RBM)**, **MSH-manpower**, dan **MSH-jobdesc**
