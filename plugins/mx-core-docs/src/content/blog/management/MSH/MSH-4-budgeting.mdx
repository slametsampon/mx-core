...
- [**_Budgeting Maintenance Berbasis Risk-Based Maintenance (RBM) di Pabrik Petrokimia_**](#budgeting-maintenance-berbasis-risk-based-maintenance-rbm-di-pabrik-petrokimia)
...
```mermaid id="msh-4-budgeting-consequence-layer-mobile"
flowchart TD
    A["Module 1-3<br/>Risk Philosophy + RBM Strategy"] --> B["Module 4<br/>RBM-Based Budgeting"]
    B --> C["Risk Decision<br/>Has Cost Consequence"]
    C --> D["Budget Line<br/>Linked to Risk"]
    D --> E["Risk Barrier Cost<br/>Locked"]
    D --> F["Optimizable Cost<br/>Controlled"]
    E --> G["Defensible<br/>Maintenance Budget"]
    F --> G

    classDef foundation fill:#E3F2FD,stroke:#1565C0,color:#111;
    classDef budget fill:#FFF8E1,stroke:#F9A825,color:#111;
...
```mermaid id="conventional-budgeting-risk-gap-mobile"
flowchart TD
    A["Conventional<br/>Maintenance Budget"] --> B["Flat Budgeting"]
    A --> C["Historical<br/>Roll-Over"]
    A --> D["Cost-Driven<br/>Cutting"]

    B --> E["Criticality<br/>Ignored"]
    C --> E
    D --> F["Risk Barrier<br/>May Be Cut"]

    E --> G["Under-Protected<br/>Critical Assets"]
    F --> G

    G --> H["Corrective<br/>Maintenance Up"]
    H --> I["Unplanned Shutdown<br/>SHE Finding<br/>Business Loss"]

    classDef conventional fill:#E3F2FD,stroke:#1565C0,color:#111;
    classDef weak fill:#FFF8E1,stroke:#F9A825,color:#111;
    classDef risk fill:#FFEBEE,stroke:#C62828,color:#111;
...
```mermaid id="rbm-budgeting-position-mobile"
flowchart TD
    A["Risk-Based<br/>Maintenance"] --> B["Assess Risk<br/>CoF + PoF"]
    B --> C["Define<br/>Control Strategy"]
    C --> D["Translate to<br/>Budget Need"]
    D --> E{"Budget<br/>Type?"}

    E --> F["Mandatory<br/>Risk Barrier Cost"]
    E --> G["Controlled<br/>Operational Cost"]
    E --> H["Optimizable<br/>Low-Risk Cost"]

    F --> I["Budget Reflects<br/>Risk Appetite"]
    G --> I
    H --> I

    classDef rbm fill:#E3F2FD,stroke:#1565C0,color:#111;
    classDef process fill:#FFF8E1,stroke:#F9A825,color:#111;
    classDef mandatory fill:#FFEBEE,stroke:#C62828,color:#111;
    classDef controlled fill:#E8F5E9,stroke:#2E7D32,color:#111;
    classDef output fill:#F3E5F5,stroke:#6A1B9A,color:#111;

    class A,B,C,D process;
    class E rbm;
    class F mandatory;
    class G,H controlled;
    class I output;
```
...
```mermaid id="rbm-budgeting-definition-mobile"
flowchart TD
    A["Risk Assessment<br/>CoF + PoF"] --> B["Maintenance<br/>Strategy"]
    B --> C["Budget<br/>Planning"]
    C --> D["Budget<br/>Allocation"]
    D --> E["Budget<br/>Locking"]
    E --> F["Budget<br/>Control"]

    F --> G["Technical + Financial<br/>Governance Artifact"]

    classDef risk fill:#FFEBEE,stroke:#C62828,color:#111;
    classDef strategy fill:#E3F2FD,stroke:#1565C0,color:#111;
    classDef budget fill:#FFF8E1,stroke:#F9A825,color:#111;
    classDef control fill:#E8F5E9,stroke:#2E7D32,color:#111;
    classDef output fill:#F3E5F5,stroke:#6A1B9A,color:#111;
...
```mermaid id="rbm-budgeting-objectives-mobile"
flowchart TD
    A["RBM-Based<br/>Maintenance Budget"] --> B["Control<br/>Process Safety Risk"]
    A --> C["Protect<br/>Critical Asset Reliability"]
    A --> D["Enable<br/>Defensible OPEX"]
    A --> E["Align with<br/>Risk Appetite"]

    B --> F["Safety + Compliance<br/>Protected"]
    C --> G["Availability + Reliability<br/>Maintained"]
    D --> H["Cost Optimized<br/>Without Risk Increase"]
    E --> I["Business Strategy<br/>Supported"]

    F --> J["Budget as<br/>Risk Control Tool"]
    G --> J
    H --> J
    I --> J

    classDef budget fill:#E3F2FD,stroke:#1565C0,color:#111;
    classDef objective fill:#E8F5E9,stroke:#2E7D32,color:#111;
    classDef result fill:#FFF8E1,stroke:#F9A825,color:#111;
    classDef output fill:#F3E5F5,stroke:#6A1B9A,color:#111;

    class A budget;
    class B,C,D,E objective;
...
```mermaid id="budgeting-as-system-output-mobile"
flowchart TD
    A["Asset<br/>Management"] --> B["Risk<br/>Assessment"]
    B --> C["Maintenance<br/>Strategy"]
    C --> D["Budget<br/>Allocation"]

    D --> E["Cost Rooted in<br/>Technical Risk"]
    E --> F["If Risk Changes<br/>Budget Must Change"]
...
```mermaid id="rbm-budget-execution-feedback-loop-mobile"
flowchart TD
    A["RBM<br/>Risk Assessment & Strategy"] --> B["Budget<br/>Risk-Based Allocation"]
    B --> C["Execution<br/>Maintenance Work"]
    C --> D["Feedback<br/>Failure / Cost / CBM Data"]
    D --> E["Update<br/>PoF / CoF / Strategy"]
    E --> A

    B --> F["Locked<br/>Risk Barrier Cost"]
    B --> G["Optimized<br/>Low-Risk Cost"]

    classDef rbm fill:#E3F2FD,stroke:#1565C0,color:#111;
    classDef budget fill:#FFF8E1,stroke:#F9A825,color:#111;
    classDef execute fill:#E8F5E9,stroke:#2E7D32,color:#111;
    classDef feedback fill:#F3E5F5,stroke:#6A1B9A,color:#111;
    classDef locked fill:#FFEBEE,stroke:#C62828,color:#111;
...
```mermaid id="budget-line-risk-question-mobile"
flowchart TD
    A["Budget<br/>Line Item"] --> B{"What Risk<br/>Does It Control?"}

    B -- "Clear Risk" --> C["Keep / Protect<br/>Budget"]
    B -- "Weak Risk Link" --> D["Review<br/>Justification"]
    B -- "No Risk Link" --> E["Candidate for<br/>Optimization"]

    C --> F["Defensible<br/>Budget"]
    D --> G["Engineering<br/>Clarification"]
    E --> H["Remove / Reduce<br/>If Safe"]
...
```mermaid id="risk-exposure-vs-control-cost-mobile"
flowchart TD
    A["Risk Exposure"] --> B["Consequence<br/>of Failure"]
    A --> C["Probability<br/>of Failure"]

    B --> D["Uncontrolled<br/>Risk Cost"]
    C --> D

    E["Risk Control<br/>Cost"] --> F["Inspection"]
    E --> G["PM / CBM"]
    E --> H["Critical Spare"]
    E --> I["TA / Shutdown"]

    F --> J["Reduced<br/>Risk Exposure"]
    G --> J
    H --> J
    I --> J

    J --> K["Optimized<br/>Cost-Risk-Reliability"]

    classDef risk fill:#FFEBEE,stroke:#C62828,color:#111;
    classDef cost fill:#FFF8E1,stroke:#F9A825,color:#111;
    classDef control fill:#E8F5E9,stroke:#2E7D32,color:#111;
    classDef output fill:#F3E5F5,stroke:#6A1B9A,color:#111;

    class A,B,C,D risk;
    class E cost;
    class F,G,H,I,J control;
    class K output;
```
...
```mermaid id="asset-criticality-budget-right-mobile"
flowchart TD
    A["Asset Criticality<br/>Assessment"] --> B["Evaluate<br/>CoF"]
    A --> C["Evaluate<br/>PoF"]

    B --> D{"Risk<br/>Class"}
    C --> D

    D -- "High Risk" --> E["Priority Budget<br/>Protected"]
    D -- "Medium Risk" --> F["Controlled Budget<br/>Selective"]
    D -- "Low Risk" --> G["Optimizable Budget<br/>Minimum"]

    classDef assess fill:#E3F2FD,stroke:#1565C0,color:#111;
...
```mermaid id="risk-class-to-budget-strategy-mobile"
flowchart TD
    A["Risk Class"] --> B["High Risk"]
    A --> C["Medium Risk"]
    A --> D["Low Risk"]

    B --> E["RBI<br/>CBM<br/>Redundancy<br/>Statutory Test"]
    C --> F["Structured PM<br/>Selective CBM<br/>Interval Optimization"]
    D --> G["Minimal PM<br/>Managed Run-to-Failure<br/>Planned Corrective"]

    E --> H["Mandatory<br/>Risk Barrier Cost"]
    F --> I["Controlled<br/>Budget"]
    G --> J["Optimized<br/>Budget"]

    classDef risk fill:#E3F2FD,stroke:#1565C0,color:#111;
    classDef high fill:#FFEBEE,stroke:#C62828,color:#111;
    classDef medium fill:#FFF8E1,stroke:#F9A825,color:#111;
    classDef low fill:#E8F5E9,stroke:#2E7D32,color:#111;
    classDef budget fill:#F3E5F5,stroke:#6A1B9A,color:#111;
...
```mermaid id="rbm-budget-structure-mobile"
flowchart TD
    A["RBM Maintenance<br/>Budget Structure"] --> B["Routine / PM<br/>Budget"]
    A --> C["Corrective<br/>Budget"]
    A --> D["Predictive / CBM<br/>Budget"]
    A --> E["TA / Shutdown<br/>Budget"]
    A --> F["Spare Parts<br/>Inventory Budget"]

    B --> G["Risk-Class<br/>Based PM"]
    C --> H["Residual<br/>Uncertainty Buffer"]
    D --> I["Risk Barrier<br/>for High CoF"]
    E --> J["Risk Reset<br/>Window"]
    F --> K["Critical / Insurance<br/>Spare"]

    classDef structure fill:#E3F2FD,stroke:#1565C0,color:#111;
    classDef budget fill:#E8F5E9,stroke:#2E7D32,color:#111;
    classDef note fill:#FFF8E1,stroke:#F9A825,color:#111;
    classDef critical fill:#FFEBEE,stroke:#C62828,color:#111;

    class A structure;
    class B,C,D,E,F budget;
    class G,H,J,K note;
    class I critical;
```
...
```mermaid id="budget-redistribution-rbm-mobile"
flowchart TD
    A["Total Maintenance<br/>Budget"] --> B["High-Risk Assets"]
    A --> C["Medium-Risk Assets"]
    A --> D["Low-Risk Assets"]

    B --> E["Budget Locked<br/>or Increased"]
    C --> F["Budget Stable<br/>or Adjusted"]
    D --> G["Budget Reduced<br/>or Optimized"]

    E --> H["Process Safety<br/>and Legal Protection"]
    F --> I["Reliability<br/>and Production Stability"]
    G --> J["Efficiency<br/>Without Risk Increase"]

    classDef total fill:#E3F2FD,stroke:#1565C0,color:#111;
    classDef high fill:#FFEBEE,stroke:#C62828,color:#111;
    classDef medium fill:#FFF8E1,stroke:#F9A825,color:#111;
    classDef low fill:#E8F5E9,stroke:#2E7D32,color:#111;
    classDef output fill:#F3E5F5,stroke:#6A1B9A,color:#111;
...
```mermaid id="budget-governance-locking-mobile"
flowchart TD
    A["Budget<br/>Governance"] --> B{"Budget<br/>Category?"}

    B -- "Risk Barrier Cost" --> C["Do Not Cut<br/>Without Validated Risk Change"]
    B -- "Operational Control Cost" --> D["Review<br/>Against Strategy"]
    B -- "Low-Risk Discretionary Cost" --> E["Optimize<br/>With Data"]

    C --> F["Pressure Equipment<br/>PSV<br/>Fire Protection<br/>Safety Instrument"]
    D --> G["PM / CBM<br/>Medium Risk Asset"]
    E --> H["Over-PM<br/>Redundant Inspection<br/>Noncritical Spare"]

    F --> I["Audit-Ready<br/>Budget Decision"]
    G --> I
    H --> I

    classDef gov fill:#E3F2FD,stroke:#1565C0,color:#111;
    classDef decision fill:#FFF8E1,stroke:#F9A825,color:#111;
    classDef locked fill:#FFEBEE,stroke:#C62828,color:#111;
    classDef review fill:#E8F5E9,stroke:#2E7D32,color:#111;
...
```mermaid id="budget-kpi-rbm-interpretation-mobile"
flowchart TD
    A["Budget KPI<br/>Observed"] --> B{"Risk Exposure<br/>Condition?"}

    B -- "Risk Stable / Down" --> C["Budget Reduction<br/>May Be Positive"]
    B -- "Risk Up" --> D["Budget Reduction<br/>Unsafe Signal"]

    A --> E{"Corrective<br/>Increasing?"}
    E -- "Yes" --> F["Risk Control<br/>Failure Alarm"]
    E -- "No" --> G["Preventive / CBM<br/>Likely Effective"]

    C --> H["Healthy<br/>Cost-Risk-Reliability"]
    D --> I["Management<br/>Review Required"]
    F --> I
    G --> H

    classDef kpi fill:#E3F2FD,stroke:#1565C0,color:#111;
    classDef decision fill:#FFF8E1,stroke:#F9A825,color:#111;
...
```mermaid id="rbm-budgeting-final-statement-mobile"
flowchart TD
    A["RBM<br/>Decision Framework"] --> B["Risk Appetite<br/>Company Commitment"]
    B --> C["Budget<br/>Structure"]
    C --> D["Locked Cost<br/>Safety & Compliance"]
    C --> E["Optimized Cost<br/>Low-Risk Area"]

    D --> F["Maintenance Manager<br/>Balances"]
    E --> F
    ...
    G --> J["Mature<br/>Maintenance System"]
    H --> J
    I --> J
    ...
    classDef budget fill:#FFF8E1,stroke:#F9A825,color:#111;
    classDef locked fill:#FFEBEE,stroke:#C62828,color:#111;
    classDef balance fill:#E8F5E9,stroke:#2E7D32,color:#111;
    classDef output fill:#F3E5F5,stroke:#6A1B9A,color:#111;

    class A,B rbm;
    class C,E budget;
    class D locked;
    class F,G,H,I balance;
    class J output;
```
...
```mermaid id="rbm-budgeting-development-roadmap-mobile"
flowchart TD
    A["RBM Budgeting<br/>Framework Locked"] --> B["Template Budget<br/>OPEX + TA"]
    B --> C["Mapping<br/>RBI / FMEA / Criticality"]
    C --> D["Budget Line<br/>Risk Traceability"]
    D --> E["BOD / Finance<br/>Presentation Framework"]
    E --> F["Management Review<br/>Risk-Based Decision"]
    F --> G["Standardized<br/>Budget Governance"]

    classDef start fill:#E3F2FD,stroke:#1565C0,color:#111;
    classDef template fill:#E8F5E9,stroke:#2E7D32,color:#111;
    classDef mapping fill:#FFF8E1,stroke:#F9A825,color:#111;
    classDef presentation fill:#F3E5F5,stroke:#6A1B9A,color:#111;
    classDef output fill:#FFEBEE,stroke:#C62828,color:#111;

    class A start;
    class B template;
    class C,D mapping;
    class E,F presentation;
    class G output;
```
