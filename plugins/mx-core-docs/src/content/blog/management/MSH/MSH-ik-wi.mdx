...
- [Template IK/WI](#template-ikwi)
  - [**RBM-COMPLIANT — ROTATING EQUIPMENT**](#rbm-compliant--rotating-equipment)
    ...
    - [**5. Tools, Alat Ukur, dan Material**](#5-tools-alat-ukur-dan-material)
    - [**6. Persyaratan SHE Khusus Rotating**](#6-persyaratan-she-khusus-rotating)
    - [**7. Urutan Kerja (Execution Sequence)**](#7-urutan-kerja-execution-sequence)
  ...
  - [**INSTRUKSI KERJA (IK) / WORK INSTRUCTION (WI)**](#instruksi-kerja-ik--work-instruction-wi)
    - [**1. Identitas Dokumen**](#1-identitas-dokumen-1)
    - [**2. Tujuan dan Ruang Lingkup**](#2-tujuan-dan-ruang-lingkup-1)
    - [**3. Konteks RBM \& Risiko Instrument**](#3-konteks-rbm--risiko-instrument)
    - [**4. Persyaratan Personel**](#4-persyaratan-personel-1)
    - [**5. Tools, Test Equipment \& Software**](#5-tools-test-equipment--software)
    - [**6. Persyaratan SHE \& Process Safety**](#6-persyaratan-she--process-safety)
    - [**7. Urutan Kerja (Execution Sequence)**](#7-urutan-kerja-execution-sequence-1)
    - [**8. Risk Trigger \& Mandatory Stop-Work**](#8-risk-trigger--mandatory-stop-work-1)
    - [**9. Escalation \& Decision Boundary**](#9-escalation--decision-boundary-1)
    - [**10. Quality Check \& Acceptance**](#10-quality-check--acceptance-1)
    - [**11. Dokumentasi \& RBM Feedback**](#11-dokumentasi--rbm-feedback)
    - [**12. RBM Lock Statement**](#12-rbm-lock-statement-1)
...
### **INSTRUKSI KERJA (IK) / WORK INSTRUCTION (WI)**

**_RBM-COMPLIANT — INSTRUMENT & CONTROL_**
