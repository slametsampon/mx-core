...
- [**_Filosofi Sistem Pemeliharaan dan Fondasi Risiko_**](#filosofi-sistem-pemeliharaan-dan-fondasi-risiko)
...
```mermaid id="msh-1-anchor-module-mobile"
flowchart TD
    A["Module 1<br/>Philosophy & Risk Foundation"] --> B["Risk-Based<br/>Thinking"]
    B --> C["Normative Basis<br/>API RP 580"]
    C --> D["Maintenance as<br/>Risk Control System"]
    D --> E["Audit-Ready<br/>Decision Framework"]

    E --> F["Foundation for<br/>RBM, KPI, TA,<br/>Organization"]

    classDef anchor fill:#E3F2FD,stroke:#1565C0,color:#111;
    classDef risk fill:#FFEBEE,stroke:#C62828,color:#111;
    classDef norm fill:#FFF8E1,stroke:#F9A825,color:#111;
...
```mermaid id="maintenance-in-petrochemical-operation-mobile"
flowchart TD
    A["Petrochemical Plant<br/>Continuous Process"] --> B["High Reliability<br/>Required"]
    B --> C["Equipment<br/>Performance"]
    C --> D["Process<br/>Stability"]
    D --> E["Safety + Environment<br/>Protection"]
    E --> F["Production<br/>Continuity"]

    C --> G{"Equipment<br/>Failure?"}
    G -- "Yes" --> H["Systemic<br/>Consequence"]
    H --> I["Shutdown Risk<br/>Business Loss"]

    classDef plant fill:#E3F2FD,stroke:#1565C0,color:#111;
    classDef reliability fill:#E8F5E9,stroke:#2E7D32,color:#111;
    classDef process fill:#FFF8E1,stroke:#F9A825,color:#111;
    classDef risk fill:#FFEBEE,stroke:#C62828,color:#111;
    classDef business fill:#F3E5F5,stroke:#6A1B9A,color:#111;

    class A plant;
    class B,C,D reliability;
    class E,F process;
    class G,H risk;
    class I business;
```
...
```mermaid id="maintenance-evolution-systemic-mobile"
flowchart TD
    A["Corrective<br/>Maintenance"] --> B["Repair After<br/>Failure"]
    B --> C["High Risk<br/>in Petrochemical"]

    D["Preventive<br/>Maintenance"] --> E["Scheduled<br/>Intervention"]
    E --> F["Good Baseline<br/>but Generic"]

    G["Predictive<br/>Maintenance"] --> H["Condition-Based<br/>Prediction"]
    H --> I["Needs Data<br/>and Risk Context"]

    C --> J["Need Integrated<br/>Risk-Based System"]
    F --> J
    I --> J

    J --> K["Balanced Strategy<br/>CM + PM + PdM"]

    classDef cm fill:#FFEBEE,stroke:#C62828,color:#111;
    classDef pm fill:#FFF8E1,stroke:#F9A825,color:#111;
    classDef pdm fill:#E3F2FD,stroke:#1565C0,color:#111;
    classDef system fill:#E8F5E9,stroke:#2E7D32,color:#111;
    classDef output fill:#F3E5F5,stroke:#6A1B9A,color:#111;
...
```mermaid id="time-based-maintenance-limitation-mobile"
flowchart TD
    A["Time-Based<br/>Maintenance"] --> B["Fixed Interval<br/>Calendar / Running Hour"]
    B --> C["Focus on<br/>Schedule Compliance"]
    C --> D{"Risk<br/>Differentiated?"}

    D -- "No" --> E["Non-Critical Asset<br/>Over-Maintained"]
    D -- "No" --> F["Critical Asset<br/>Under-Protected"]

    E --> G["Cost + Manpower<br/>Inefficiency"]
    F --> H["High Consequence<br/>Failure Risk"]

    G --> I["Need<br/>Risk-Based Priority"]
    H --> I
...
```mermaid id="risk-based-thinking-maintenance-foundation-mobile"
flowchart TD
    A["Risk-Based<br/>Thinking"] --> B["Identify<br/>Failure Scenario"]
    B --> C["Assess<br/>Probability of Failure"]
    B --> D["Assess<br/>Consequence of Failure"]

    C --> E["Risk<br/>Evaluation"]
    D --> E

    E --> F{"Risk<br/>Acceptable?"}
    F -- "Yes" --> G["Maintain Strategy<br/>and Monitor"]
    F -- "No" --> H["Define<br/>Maintenance Mitigation"]

    H --> I["Inspection<br/>Repair<br/>Replacement<br/>Modification"]
    I --> J["Reduced<br/>Residual Risk"]
    J --> G

    classDef concept fill:#E3F2FD,stroke:#1565C0,color:#111;
    classDef assess fill:#FFF8E1,stroke:#F9A825,color:#111;
    classDef decision fill:#F3E5F5,stroke:#6A1B9A,color:#111;
    classDef action fill:#E8F5E9,stroke:#2E7D32,color:#111;
    classDef risk fill:#FFEBEE,stroke:#C62828,color:#111;

    class A concept;
    class B,C,D,E assess;
    class F decision;
    class H,I action;
    class J risk;
    class G action;
...
```mermaid id="rbi-normative-foundation-mobile"
flowchart TD
    A["Risk-Based<br/>Inspection"] --> B["API RP 580<br/>Normative Framework"]
    B --> C["Risk Assessment<br/>PoF + CoF"]
    C --> D["Inspection<br/>Priority"]
    C --> E["Inspection<br/>Frequency"]
    C --> F["Inspection<br/>Depth"]

    D --> G["Maintenance<br/>Decision Basis"]
    E --> G
    F --> G

    G --> H["Audit-Ready<br/>Risk Justification"]

    classDef rbi fill:#E3F2FD,stroke:#1565C0,color:#111;
    classDef api fill:#FFF8E1,stroke:#F9A825,color:#111;
    classDef risk fill:#FFEBEE,stroke:#C62828,color:#111;
...
```mermaid id="maintenance-she-barrier-mobile"
flowchart TD
    A["Equipment<br/>Degradation"] --> B["Maintenance<br/>Barrier"]

    B --> C["Inspection"]
    B --> D["Preventive<br/>Maintenance"]
    B --> E["Condition<br/>Monitoring"]
    B --> F["Corrective<br/>Action"]

    C --> G["Prevent<br/>Loss of Containment"]
    D --> G
    E --> G
    F --> G

    G --> H["Safety<br/>Protection"]
    G --> I["Environmental<br/>Protection"]
    G --> J["Operation<br/>Continuity"]

    classDef degradation fill:#FFEBEE,stroke:#C62828,color:#111;
    classDef barrier fill:#E3F2FD,stroke:#1565C0,color:#111;
    classDef action fill:#E8F5E9,stroke:#2E7D32,color:#111;
    classDef protection fill:#FFF8E1,stroke:#F9A825,color:#111;
    classDef output fill:#F3E5F5,stroke:#6A1B9A,color:#111;
...
```mermaid id="module-1-final-logic-mobile"
flowchart TD
    A["Petrochemical<br/>High-Risk Context"] --> B["Maintenance Cannot Be<br/>Only Technical Activity"]
    B --> C["Need<br/>Risk-Based Thinking"]
    C --> D["Use<br/>Normative Basis"]
    D --> E["API RP 580<br/>RBI Framework"]
    E --> F["Maintenance as<br/>Risk Control System"]
    F --> G["Structured<br/>Defensible<br/>Audit-Ready"]

    classDef context fill:#E3F2FD,stroke:#1565C0,color:#111;
    classDef shift fill:#FFF8E1,stroke:#F9A825,color:#111;
    classDef risk fill:#FFEBEE,stroke:#C62828,color:#111;
    classDef norm fill:#E8F5E9,stroke:#2E7D32,color:#111;
    classDef output fill:#F3E5F5,stroke:#6A1B9A,color:#111;
...
```mermaid id="module-1-connection-to-next-modules-mobile"
flowchart TD
    A["Module 1<br/>Risk-Based Philosophy"] --> B["Module 2<br/>Risk Model & Decision Logic"]
    B --> C["Module 3<br/>RBM Practical Execution"]
    C --> D["Module 5<br/>Organization, KPI & Accountability"]
    D --> E["Lifecycle / TA<br/>Continuous Improvement"]

    A --> F["Defines<br/>Why Maintenance is Risk Control"]
    B --> G["Defines<br/>How Risk Becomes Decision"]
    C --> H["Defines<br/>How Decision Becomes Strategy"]
    D --> I["Defines<br/>Who Owns Decision"]
    E --> J["Defines<br/>How System Learns"]
    ...
    classDef m5 fill:#F3E5F5,stroke:#6A1B9A,color:#111;
    classDef lifecycle fill:#FFEBEE,stroke:#C62828,color:#111;
