...
date: '2024-09-27'
tags:
  ['ftfr', 'kompetensi', 'ketrampilan', 'troubleshooting', 'Risk-Management']
draft: false
...
```mermaid
  flowchart TD
    A[Gangguan Peralatan] --> B[Teknisi Melakukan Diagnosa]
    B --> C{Masalah Selesai<br/>pada Upaya Pertama?}
    C -->|Ya| D[Berhasil<br/>First-Time Fix]
    C -->|Tidak| E[Perlu Kunjungan Ulang]
    D --> F[FTFR Meningkat]
    E --> G[FTFR Menurun]

    style A fill:#FFE5B4,stroke:#D35400,color:#000
    style B fill:#D6EAF8,stroke:#2874A6,color:#000
    ...
    style F fill:#ABEBC6,stroke:#1E8449,color:#000
    style G fill:#F5B7B1,stroke:#922B21,color:#000
```
...
[**Kembali ke Atas**](#1-pendahuluan-apa-itu-first-time-fix-rate-ftfr-dan-mengapa-penting)
...
```mermaid
flowchart TD
    A[Tantangan FTFR<br/>di Pabrik Petrokimia]

    A --> B[Kompleksitas Peralatan]
    A --> C[Diagnosa Sulit]
    A --> D[Suku Cadang Tidak Siap]
    A --> E[Pelatihan Kurang]
    A --> F[Komunikasi Lemah]

    B --> G[Pompa<br/>Kompresor<br/>PLC/DCS]
    C --> H[Root Cause Tidak Tepat]
    D --> I[Perbaikan Tertunda]
    E --> J[Kompetensi Tidak Merata]
    F --> K[Informasi Lapangan Tidak Lengkap]

    style A fill:#D6EAF8,stroke:#1F618D,color:#000
    style B fill:#FCF3CF,stroke:#B7950B,color:#000
    style C fill:#FADBD8,stroke:#C0392B,color:#000
    style D fill:#FDEBD0,stroke:#CA6F1E,color:#000
    style E fill:#E8DAEF,stroke:#7D3C98,color:#000
    style F fill:#D5F5E3,stroke:#239B56,color:#000
```
...
```mermaid
flowchart TD
    A[Program Peningkatan FTFR]

    A --> B[Kolaborasi Lintas Fungsi]
    A --> C[Pemeliharaan Proaktif]
    A --> D[Data & CMMS]
    A --> E[Kompetensi Teknisi]

    B --> F[Operasi<br/>Maintenance<br/>Inventory<br/>Reliability]
    C --> G[Preventive<br/>Predictive<br/>RCA]
    D --> H[Riwayat Kerusakan<br/>Spare Part<br/>Backlog]
    E --> I[Diagnosa<br/>Troubleshooting<br/>Safety]
    ...
    style A fill:#D6EAF8,stroke:#1F618D,color:#000
    style B fill:#D5F5E3,stroke:#239B56,color:#000
    style C fill:#FCF3CF,stroke:#B7950B,color:#000
    style D fill:#E8DAEF,stroke:#7D3C98,color:#000
    style E fill:#FDEBD0,stroke:#CA6F1E,color:#000
    style J fill:#ABEBC6,stroke:#1E8449,color:#000
```
...
```mermaid
flowchart TD
    A[Mulai Program FTFR]
    A --> B[Audit Kondisi Awal]
    B --> C[Tentukan Gap]
    C --> D[Tetapkan Target FTFR]
    D --> E[Pelatihan & Persiapan Tools]
    E --> F[Pilot Project]
    F --> G[Evaluasi Hasil]
    G --> H{Target Tercapai?}
    H -->|Belum| I[Perbaiki Program]
    I --> F
    H -->|Ya| J[Roll Out ke Area Lain]
    J --> K[Monitoring Berkelanjutan]

    style A fill:#D6EAF8,stroke:#1F618D,color:#000
    style B fill:#FCF3CF,stroke:#B7950B,color:#000
    style C fill:#FDEBD0,stroke:#CA6F1E,color:#000
    style D fill:#D5F5E3,stroke:#239B56,color:#000
    style E fill:#E8DAEF,stroke:#7D3C98,color:#000
    style F fill:#D6EAF8,stroke:#2874A6,color:#000
...
```mermaid
flowchart TD
    A[Nilai FTFR Pabrik Petrokimia]
    ...
    B --> F[Kritis<br/>Banyak Rework]
    C --> G[Cukup<br/>Perlu Perbaikan]
    D --> H[Baik<br/>Sistem Mulai Stabil]
    E --> I[Excellent<br/>Pemeliharaan Proaktif Matang]

    style A fill:#D6EAF8,stroke:#1F618D,color:#000
    style B fill:#F5B7B1,stroke:#922B21,color:#000
    style C fill:#FAD7A0,stroke:#CA6F1E,color:#000
    style D fill:#FCF3CF,stroke:#B7950B,color:#000
    style E fill:#ABEBC6,stroke:#1E8449,color:#000
```
...
flowchart TD
    A[Monitor FTFR]
    A --> B[Analisis Penyebab Rendahnya FTFR]
    B --> C[Perbaiki Kompetensi]
    C --> D[Perbaiki Spare Part]
    D --> E[Perbaiki Prosedur & CMMS]
    E --> F[Eksekusi Pemeliharaan Lebih Baik]
    F --> G[FTFR Meningkat]
    G --> A

    style A fill:#D6EAF8,stroke:#1F618D,color:#000
    style B fill:#FCF3CF,stroke:#B7950B,color:#000
    style C fill:#E8DAEF,stroke:#7D3C98,color:#000
    style D fill:#FDEBD0,stroke:#CA6F1E,color:#000
    style E fill:#D5F5E3,stroke:#239B56,color:#000
    style F fill:#ABEBC6,stroke:#1E8449,color:#000
    style G fill:#82E0AA,stroke:#196F3D,color:#000
```
