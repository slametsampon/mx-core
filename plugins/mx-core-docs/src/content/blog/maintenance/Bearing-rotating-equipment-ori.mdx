...
- [**_Bearing pada Rotating Equipment: Panduan Praktis Berbasis Engineering dan Lifecycle Maintenance_**](#bearing-pada-rotating-equipment-panduan-praktis-berbasis-engineering-dan-lifecycle-maintenance)
  ...
  - [3.1 Parameter pada Rolling Bearing](#31-parameter-pada-rolling-bearing)
    ...
    - [Equivalent Dynamic Load](#equivalent-dynamic-load)
    - [Life Modification Factor](#life-modification-factor)
  - [3.2 Parameter pada Journal / Sleeve Bearing](#32-parameter-pada-journal--sleeve-bearing)
    - [Bearing Pressure](#bearing-pressure)
    - [Sommerfeld Number](#sommerfeld-number)
  ...
  - [10. Ringkasan Praktis](#10-ringkasan-praktis)
    - [Mengapa Bearing Bisa Gagal Lebih Cepat dari Umur Hitung](#mengapa-bearing-bisa-gagal-lebih-cepat-dari-umur-hitung)
...
- (L\_{10}) = umur bearing (juta revolusi)
...
- (L\_{na}) = modified rating life
- (a_1) = reliability factor
- (a\_{ISO}) = life modification factor
- (L\_{10}) = basic rating life

Nilai (a\_{ISO}) dipengaruhi oleh:
...
Dalam konteks life modification factor, kontaminasi akan menurunkan nilai \(a\_{\mathrm{ISO}}\) sehingga umur aktual bearing menjadi jauh lebih rendah dari nilai L10.
