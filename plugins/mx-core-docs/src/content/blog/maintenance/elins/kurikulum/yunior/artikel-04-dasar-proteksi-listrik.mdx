...
- [📘 ARTIKEL 4: Dasar Proteksi Listrik \& ANSI Relay Code (50/51/27/59) dalam Konteks Sistem](#-artikel-4-dasar-proteksi-listrik--ansi-relay-code-50512759-dalam-konteks-sistem)
  ...
  - [7️⃣ ANSI 50 — Instantaneous Phase Overcurrent](#7️⃣-ansi-50--instantaneous-phase-overcurrent)
    - [Fungsi](#fungsi)
    - [Karakteristik Teknis](#karakteristik-teknis)
    - [⚠ Klarifikasi Penting: Phase Fault vs Ground Fault](#-klarifikasi-penting-phase-fault-vs-ground-fault)
    - [Peran dalam Koordinasi](#peran-dalam-koordinasi)
    - [Insight Engineering](#insight-engineering)
  - [8️⃣ ANSI 51 — Time Overcurrent (Phase Overcurrent dengan Delay)](#8️⃣-ansi-51--time-overcurrent-phase-overcurrent-dengan-delay)
    - [Fungsi](#fungsi-1)
    - [Digunakan untuk](#digunakan-untuk)
    - [⚠ Klarifikasi Penting: ANSI 51 vs ANSI 49](#-klarifikasi-penting-ansi-51-vs-ansi-49)
    - [Peran dalam Selective Coordination](#peran-dalam-selective-coordination)
    - [Insight Engineering](#insight-engineering-1)
  ...
  - [🔟 ANSI 59 — Overvoltage Protection](#-ansi-59--overvoltage-protection)
    ...
    - [Insight Engineering](#insight-engineering-2)
  - [🟡 Ground Fault Protection Philosophy](#-ground-fault-protection-philosophy)
    - [Mengapa Ground Fault Sangat Kritis?](#mengapa-ground-fault-sangat-kritis)
    - [Proteksi Ground Fault Umum](#proteksi-ground-fault-umum)
      - [🔹 ANSI 50G / 51G — Ground Overcurrent](#-ansi-50g--51g--ground-overcurrent)
      - [🔹 ANSI 64 — Ground Detection Khusus](#-ansi-64--ground-detection-khusus)
    - [Filosofi Engineering](#filosofi-engineering)
    - [Insight System-Level](#insight-system-level-1)
  - [📊 TABEL KOMPARATIF ANSI FUNCTION (Siap Copas)](#-tabel-komparatif-ansi-function-siap-copas)
