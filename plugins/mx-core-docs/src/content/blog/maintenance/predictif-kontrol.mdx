...
1. **Kendali Otomatis (Automatic Control)**:
   ...
   ![control_systems](/mx-core/static/images/artikel/control_systems.png)
   ...
   ![control-system-with-both-feedforward-and-feedback-l](/mx-core/static/images/artikel/control-system-with-both-feedforward-and-feedback-l.jpg)
...
3. **Kendali Pengoptimalan (Optimization Control)**:
   ...
   ![MPC](/mx-core/static/images/artikel/Model-Predictive-Control-MPC-scheme-of-the-control-for-the-the-Heating-Ventilating-and.png)
...
![MPC1](/mx-core/static/images/artikel/mpc1.jpg)
