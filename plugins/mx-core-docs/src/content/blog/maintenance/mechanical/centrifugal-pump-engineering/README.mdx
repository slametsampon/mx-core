  ...
  items={[
    {
      ...
      href: '/blog/maintenance/mechanical/centrifugal-pump-engineering/01-centrifugal-pump-fundamentals',
      description: 'Centrifugal Pump Fundamentals',
    },
  ]}
/>
---
...
<ResourceBox
  ...
  items={[
    {
      name: 'Pump Performance Curve',
      href: '/blog/maintenance/mechanical/centrifugal-pump-engineering/02-pump-performance-curve-and-operating-point',
      description: 'Pump Performance Curve and Operating Point',
    },
  ]}
/>
---
  ...
  items={[
    {
      ...
      href: '/blog/maintenance/mechanical/centrifugal-pump-engineering/03-total-dynamic-head-calculation',
      description: 'Total Dynamic Head Calculation',
    },
  ]}
/>
---
...
<ResourceBox
  ...
  items={[
    {
      name: 'NPSH and Cavitation',
      href: '/blog/maintenance/mechanical/centrifugal-pump-engineering/04-npsh-and-cavitation-in-centrifugal-pumps',
      description: 'NPSH and Cavitation in Centrifugal Pumps',
    },
  ]}
/>
---
...
<ResourceBox
  ...
  items={[
    {
      name: 'Centrifugal Pump Selection',
      href: '/blog/maintenance/mechanical/centrifugal-pump-engineering/05-centrifugal-pump-selection-engineering',
      description: 'Centrifugal Pump Selection Engineering',
    },
  ]}
/>
---
...
<ResourceBox
  ...
  items={[
    {
      name: 'Centrifugal Pump Installation',
      href: '/blog/maintenance/mechanical/centrifugal-pump-engineering/06-centrifugal-pump-installation-engineering',
      description: 'Centrifugal Pump Installation Engineering',
    },
  ]}
/>
---
...
<ResourceBox
  ...
  items={[
    {
      name: 'Centrifugal Pump Operation',
      href: '/blog/maintenance/mechanical/centrifugal-pump-engineering/07-centrifugal-pump-operation-behavior',
      description: 'Centrifugal Pump Operation Behavior',
    },
  ]}
/>
---
  ...
  items={[
    {
      ...
      href: '/blog/maintenance/mechanical/centrifugal-pump-engineering/08-centrifugal-pump-maintenance-and-reliability',
      description: 'Centrifugal Pump Maintenance and Reliability',
    },
  ]}
/>
---
