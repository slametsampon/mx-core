...
- [🔒 **Catatan Editorial — Penyempurnaan Opsional (High-Level)**](#-catatan-editorial--penyempurnaan-opsional-high-level)
...
flowchart TD
    A["Risk-Based<br/>Maintenance"] --> B["Risk<br/>Understanding"]
    B --> C["ESC Impact"]
    C --> D["Tier<br/>Classification"]
    D --> E["Maintenance<br/>Strategy"]
    E --> F["Work Order<br/>Execution"]
    F --> G["Review<br/>Periodik"]
    G --> B

    classDef rbm fill:#dbeafe,stroke:#2563eb,color:#1e3a8a;
    classDef risk fill:#fee2e2,stroke:#dc2626,color:#7f1d1d;
    classDef tier fill:#fef3c7,stroke:#d97706,color:#78350f;
...
flowchart TD
    A["Evaluasi<br/>Aset"] --> B["Safety<br/>Impact"]
    A --> C["Environment<br/>Impact"]
    A --> D["Continuous<br/>Operation"]
    A --> E["Redundansi"]
    A --> F["Histori<br/>Gangguan"]
    A --> G["Akses &<br/>MTTR"]
    ...
    H --> I{"Tier?"}
    I --> J["Tier 1<br/>Realtime / Harian"]
    I --> K["Tier 2<br/>Bulanan"]
    I --> L["Tier 3<br/>6 Bulanan"]

    classDef input fill:#e0f2fe,stroke:#0284c7,color:#075985;
    classDef esc fill:#fee2e2,stroke:#dc2626,color:#7f1d1d;
    classDef decision fill:#fef3c7,stroke:#d97706,color:#78350f;
    classDef t1 fill:#fecaca,stroke:#b91c1c,color:#7f1d1d;
    classDef t2 fill:#fde68a,stroke:#d97706,color:#78350f;
    classDef t3 fill:#bbf7d0,stroke:#16a34a,color:#14532d;
...
flowchart TD
    A["PT PON<br/>Continuous Plant"] --> B["ESC High<br/>Impact"]
    A --> C["ESC Medium<br/>Impact"]
    A --> D["ESC Low<br/>Impact"]
    ...
    E --> H["Reformer"]
    E --> I["Hydrogen<br/>Compressor"]
    F --> J["PSA Unit"]
    F --> K["Cooling<br/>System"]
    G --> L["Backup<br/>Panel"]
    G --> M["Auxiliary<br/>System"]

    classDef plant fill:#dbeafe,stroke:#2563eb,color:#1e3a8a;
    ...
    classDef equip fill:#f8fafc,stroke:#64748b,color:#334155;

    class A plant;
    class B,E,H,I high;
    class C,F,J,K medium;
    class D,G,L,M low;
```
...
flowchart TD
    A["Tier<br/>Asset"] --> B{"Level<br/>Tier"}
    ...
    C --> F["CBM Intensif"]
    C --> G["TA Priority"]
    C --> H["Critical<br/>Spare"]

    D --> I["Monthly<br/>Inspection"]
    D --> J["Planned<br/>TBM"]
    D --> K["Review<br/>Degradasi"]

    E --> L["Basic<br/>TBM"]
    E --> M["6 Monthly<br/>Check"]
    E --> N["Run to Plan"]

    classDef root fill:#dbeafe,stroke:#2563eb,color:#1e3a8a;
    classDef decide fill:#fef3c7,stroke:#d97706,color:#78350f;
    classDef t1 fill:#fee2e2,stroke:#dc2626,color:#7f1d1d;
    classDef t2 fill:#fde68a,stroke:#d97706,color:#78350f;
    classDef t3 fill:#dcfce7,stroke:#16a34a,color:#14532d;
...
flowchart TD
    A["Master<br/>Asset List"] --> B["Tier<br/>Evaluation"]
    B --> C["Tier<br/>Attribute"]
    C --> D["CMMS /<br/>Spreadsheet"]
    D --> E["PM Schedule"]
    D --> F["CBM Route"]
    D --> G["Spare Part<br/>Priority"]
    D --> H["TA Scope"]
    E --> I["Work Order"]
    F --> I
    G --> I
    H --> I
    I --> J["History &<br/>Feedback"]
    J --> B

    classDef data fill:#e0f2fe,stroke:#0284c7,color:#075985;
    classDef tier fill:#fef3c7,stroke:#d97706,color:#78350f;
    classDef system fill:#ede9fe,stroke:#7c3aed,color:#4c1d95;
    classDef output fill:#dcfce7,stroke:#16a34a,color:#14532d;
    classDef feedback fill:#fee2e2,stroke:#dc2626,color:#7f1d1d;

    class A data;
    class B,C tier;
    class D system;
    class E,F,G,H,I output;
    class J feedback;
```
...
flowchart TD
    A["Mulai<br/>Pilot Unit"] --> B["Workshop<br/>Lintas Fungsi"]
    B --> C["Klasifikasi<br/>Tier Awal"]
    C --> D["Integrasi<br/>CMMS"]
    D --> E["Eksekusi<br/>PM / CBM"]
    E --> F["Monitoring<br/>Kinerja"]
    F --> G{"Perlu<br/>Update?"}
    G -->|"Ya"| H["Revisi<br/>Tier"]
    H --> C
    G -->|"Tidak"| I["Review<br/>Tahunan"]
    I --> B

    classDef start fill:#dbeafe,stroke:#2563eb,color:#1e3a8a;
    classDef process fill:#dcfce7,stroke:#16a34a,color:#14532d;
    classDef decision fill:#fef3c7,stroke:#d97706,color:#78350f;
    classDef revise fill:#fee2e2,stroke:#dc2626,color:#7f1d1d;
...
> **Bagian ini bersifat opsional dan tidak wajib diterapkan.**
> Direkomendasikan **hanya jika sistem Tier ingin dinaikkan ke level _rujukan utama Maintenance System Handbook (MSH) / RBM nasional_**, atau digunakan sebagai **baseline kebijakan lintas plant**.
...
flowchart TD
    A["Keputusan<br/>Berbasis Tier"] --> B{"Menyentuh<br/>Process Safety?"}
    B -->|"Tidak"| C["Gunakan Tier<br/>untuk Planning"]
    B -->|"Ya"| D["STOP<br/>Tiering"]

    D --> E{"Risiko<br/>Dominan?"}
    E --> F["RBI<br/>API 580 / 581"]
    E --> G["FTA"]
    E --> H["Bowtie<br/>Analysis"]

    F --> I["Risk<br/>Decision"]
    G --> I
    H --> I
    I --> J["Strategy &<br/>Execution"]

    classDef normal fill:#dcfce7,stroke:#16a34a,color:#14532d;
    classDef decision fill:#fef3c7,stroke:#d97706,color:#78350f;
    classDef stop fill:#fee2e2,stroke:#dc2626,color:#7f1d1d;
    classDef formal fill:#ede9fe,stroke:#7c3aed,color:#4c1d95;

    class A,C,J normal;
    class B,E decision;
    class D stop;
    class F,G,H,I formal;
```

🔁 **Eskalasi Wajib**
Dalam kondisi tersebut, Tier **harus dihentikan** dan dialihkan ke metode formal berikut:
...
> **Prinsip kunci:** > _Tier adalah alat perencanaan, bukan alat penentu keselamatan proses._
...
> **Penegasan:** > _Tier adalah alat bantu keputusan, bukan alat legitimasi keputusan yang salah._
...
- dan berfungsi sebagai **tactical enabler**, bukan _risk shortcut_.
...
flowchart TD
    A["Start"] --> B["Input Data<br/>Aset"]
    B --> C["ESC<br/>Grading"]
    C --> D["Checklist<br/>Tier"]
    D --> E{"Hasil<br/>Tier"}

    E --> F["Tier 1<br/>Realtime"]
    E --> G["Tier 2<br/>Bulanan"]
    E --> H["Tier 3<br/>6 Bulanan"]

    F --> I["CM / CBM"]
    I --> J["CMMS<br/>Notification"]
    J --> K["Auto / Urgent<br/>WO"]

    G --> L["TBM<br/>Planned"]
    L --> M["Manual<br/>Evaluation"]
    M --> N["Planned<br/>WO"]

    H --> O["Light<br/>Inspection"]
    O --> P["Yearly / Routine<br/>WO"]

    K --> Q["Review<br/>Tahunan"]
    N --> Q
    P --> Q
    Q --> R["Update<br/>Tier"]
    R --> C
